...
| [GAL-10](GAL-10.md) | Public UI та обкладинки у списках              |  2   | GAL-6, GAL-7                | done   |
| [GAL-11](GAL-11.md) | Видалення legacy photo flow і cleanup          |  2   | GAL-4, GAL-9, GAL-10        | done   |
| [GAL-12](GAL-12.md) | Наскрізна регресія та документація             |  3   | GAL-6, GAL-7, GAL-9, GAL-11 | ready  |
