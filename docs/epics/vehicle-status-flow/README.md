...
| [VSF-18](VSF-18.md) | Видалення поля `repairNote`                             |  2   | VSF-9, VSF-11, VSF-16         | done   |
| [VSF-20](VSF-20.md) | Розщеплення техпаспорта (без/з печаткою)                |  2   | VSF-9, VSF-11, VSF-16         | done   |
| [VSF-19](VSF-19.md) | Алерти в історії статусів (рефактор подачі)             |  2   | VSF-8, VSF-10, VSF-11, VSF-20 | done   |
