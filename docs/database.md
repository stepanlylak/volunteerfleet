...
- **`pnpm db:seed:demo`** — демо-дані для наповнення (кілька авто в різних статусах, витрати з різними
  валютами й категоріями, документи). Запускається вручну, не в проді/тесті.
